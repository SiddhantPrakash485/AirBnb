  ...
  return (
    <div className="w-[100vw] min-h-[100vh] flex items-center justify-center gap-[10px] bg-slate-200 flex-col">
      ...
      <div className="w-[95%] max-w-[600px] h-[200px] bg-[white] flex items-center justify-center border-[1px] border-[#b5b5b5] flex-col gap-[20px] p-[20px] md:w-[80%] rounded-lg">
        ...
        <button className="px-[30px] py-[10px] text-[18px] bg-[red] text-[white] md:px-[100px] rounded-lg text-nowrap" onClick={()=>{
      ...
      <button
        className="px-[30px] py-[10px] text-[18px] bg-[red] text-[white] md:px-[100px] rounded-lg text-nowrap absolute top-[10px] right-[20px] "
        onClick={()=>navigate("/")}
      >
        Back To Home
      </button>
